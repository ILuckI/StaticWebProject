!function () {
    ...
    function o(t) {
        var e = t.namespaceURI === y ? "xlink:href" : "src";
        return t.hasAttribute(e)
    }

    function a(t) {
        return !(t.type && !b[t.type]) && ((!S || !t.hasAttribute("nomodule")) && !(!S && "module" === t.type))
    }
    ...
    function v(t, e) {
        var n = new A(t), r = new k(n);
        n.harvestScriptsInDocument(), new D(n, {
            blocking: e, docWriteSimulator: r, callback: function () {
                e || m(t)
            }
        }).run()
    }
    ...
    function m(t) {
        var e = new I(t);
        L.simulateStateBeforeDeferScriptsActivation(), e.harvestDeferScriptsInDocument(), new D(e, {
            blocking: !1,
            callback: function () {
                L.simulateStateAfterDeferScriptsActivation(), C && C()
            }
        }).run()
    }

    var y = "http://www.w3.org/2000/svg", b = {
            ...
            "text/x-javascript": !0,
            module: !0
        }, S = void 0 !== document.createElement("script").noModule, x = document.write, w = document.writeln,
        g = Object.setPrototypeOf || {__proto__: []} instanceof Array && function (t, e) {
            t.__proto__ = e
        } || function (t, e) {
            ...
            return Object.defineProperty(t.prototype, "hasItems", {
                ...
                var n = this, r = e.filter, i = e.mutate;
                ...
                var e = t.parentNode, n = this.createPlaceholder(t), r = o(t);
            ...
            return f(e, t), e.prototype.harvestScriptsInDocument = function () {
                var t = this;
            ...
            return f(e, t), e.prototype.harvestDeferScriptsInDocument = function () {
                var t = this;
                this.harvestScripts(document, {
                    filter: function (e) {
            ...
            return t.prototype.enable = function (t) {
                ...
                document.write = x, document.writeln = w, this.buffer.length && (document.contains(this.insertionPointMarker) ? this.insertionPointMarker.parentNode === document.head ? this.insertContentInHead() : this.insertContentInBody() : e("Insertion point marker for document.write was detached from document:", "Markup will not be inserted"))
                ...
                if (this.scriptStack.harvestScriptsAfterDocWrite(i), n(i.head.childNodes, this.insertionPointMarker), i.body.childNodes.length) {
                    ...
                    document.body || x.call(document, "<body>"), r(o, document.body)
                }
                ...
                n && o(n) && n.hasAttribute("async") ? (r = e ? w : x).call.apply(r, [document].concat(t)) : this.buffer += t.map(String).join(e ? "\n" : "");
                var r
            }, t
        }(), E = function () {
            function t() {
            ...
            return t.prototype.runOnLoad = function (t) {
                ...
                var n = this, r = t.addEventListener;
                t.addEventListener = function (i, o) {
                    for (var a = [], c = 2; c < arguments.length; c++) a[c - 2] = arguments[c];
                    var s = o;
                    if (o && "handleEvent" in o && (o = o.handleEvent), "function" == typeof o) {
                        var u = n;
                        s = function (t) {
                            if (u.bypassEventsInProxies || e.indexOf(i) < 0) return o.call(this, t)
                        }
                    }
            ...
            var t = window;
            return t.__rocketLoaderLoadProgressSimulator || Object.defineProperty(t, "__rocketLoaderLoadProgressSimulator", {value: new E}), t.__rocketLoaderLoadProgressSimulator
        }(), D = function () {
            function t(t, e) {
                this.scriptStack = t, this.settings = e
            }
            ...
            return t.prototype.run = function () {
                ...
                this.settings.docWriteSimulator && !t.async && this.settings.docWriteSimulator.flushWrittenContentAndDisable(), L.updateInlineHandlers(), i(t.placeholder)
            }, t.prototype.activateScript = function (t) {
                var n = t.script, r = t.placeholder, i = t.external, o = t.async, a = r.parentNode;
    ...
    !function () {
        ...
        if (t) {
            ...
            if (n) {
                ...
                L.updateInlineHandlers(), r ? o() : (h(), L.runOnLoad(o))
